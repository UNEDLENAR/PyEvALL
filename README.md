<img src="img/Logo_PyEvALL.png" alt="image" width="300" height="auto" style="border-radius:50%">
<a href="url"><img src="img/Logo_PyEvALL.png" height="auto" width="200" style="display: block;    border-radius: 50%;  "></a>
